...
python3 conditional_ddpm_train_v2.py --overfit --data_dir /dtu/blackhole/1d/214141/CheXpert-v1.0-small   --output_dir /work3/s243891/chest_xray_diffusion_overfit_A  --resolution 128   --train_batch_size 4  --num_epochs 30000   --dataloader_num_workers 4   --learning_rate 1e-4   --use_ema   --mixed_precision fp16 --resume_from_checkpoint latest --checkpointing_steps 1000
